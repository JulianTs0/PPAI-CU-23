...
public class ClasificacionSismo {
    ...
    public ClasificacionSismo(double kmProfundidadDesde_in, double kmProfundidadHasta_in, String nombre_in) {
        this.kmProfundidadDesde = kmProfundidadDesde_in;
        this.kmProfundidadHasta = kmProfundidadHasta_in;
